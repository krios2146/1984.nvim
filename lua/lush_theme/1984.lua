...
local theme = lush(function(injected_functions)
  ...
  return {
    ...
    Cursor         { bg = c.cyan, fg = c.white }, -- Character under the cursor
    -- CurSearch      { }, -- Highlighting a search pattern under the cursor (see 'hlsearch')
    -- lCursor        { }, -- Character under the cursor when |language-mapping| is used (see 'guicursor')
    -- CursorIM       { }, -- Like Cursor, but used when in IME mode |CursorIM|
    -- CursorColumn   { }, -- Screen-column at the cursor, when 'cursorcolumn' is set.
    CursorLine     { bg = c.bg.darken(30) }, -- Screen-line at the cursor, when 'cursorline' is set. Low-priority if foreground (ctermfg OR guifg) is not set.
    ...
    LineNr         { fg = c.fg.darken(65) }, -- Line number for ":number" and ":#" commands, and when 'number' or 'relativenumber' option is set.
    ...
    Comment        { fg = c.fg.darken(65) }, -- Any comment
    ...
    --
    LspReferenceText            { bg = c.bg.lighten(50) } , -- Used for highlighting "text" references
    LspReferenceRead            { bg = c.bg.lighten(50) } , -- Used for highlighting "read" references
    LspReferenceWrite           { bg = c.bg.lighten(50) } , -- Used for highlighting "write" references
    -- LspCodeLens                 { } , -- Used to color the virtual text of the codelens. See |nvim_buf_set_extmark()|.
    -- LspCodeLensSeparator        { } , -- Used to color the seperator between two or more code lens.
    LspSignatureActiveParameter { bg = c.bg.lighten(50) } , -- Used to highlight the active parameter in the signature help. See |vim.lsp.handlers.signature_help()|.
    ...
    sym"@text.literal"      { fg = Comment.fg }, -- Comment
    ...
    sym"@string.special"    { fg = c.magenta.rotate(-10) }, -- SpecialChar
    sym"@string.escape"     { sym"@string.special" }, -- SpecialChar
    -- sym"@character"         { }, -- Character
    sym"@character.special" { sym"@string.special" }, -- SpecialChar
    -- sym"@number"            { }, -- Number
    -- sym"@boolean"           { }, -- Boolean
    -- sym"@float"             { }, -- Float
    ...
    sym"@keyword"           { fg = c.cyan, gui = "italic" }, -- Keyword
    -- sym"@exception"         { }, -- Exception
    sym"@variable"          { fg = c.blue }, -- Identifier
    -- sym"@type"              { }, -- Type
